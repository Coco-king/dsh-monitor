  ...
  "lib/client-src/i18n.js"() {
    MESSAGES = {
      zh: {
        ...
        pricesCurrencyHint: "\u4E2D\u6587\u754C\u9762\u6309\u4EBA\u6C11\u5E01\u5C55\u793A\u4E0E\u7F16\u8F91,\u5B58\u56DE\u8D26\u672C\u4E5F\u662F\u4EBA\u6C11\u5E01;\u5207\u6362\u5230\u82F1\u6587\u754C\u9762\u663E\u793A\u5E76\u7F16\u8F91\u7F8E\u5143\u4EF7\u683C\u3002",
      ...
      en: {
        ...
        pricesCurrencyHint: "Prices are shown and edited in USD in English UI, stored as USD; switch to Chinese UI to view and edit CNY prices.",
...
var require_panel = __commonJS({
  "lib/client-src/panel.js"(exports2, module2) {
    ...
    function SessionCost2(props) {
      ...
      const locale = resolveLocale3(config.locale);
  ...
  "lib/client-src/settings.js"(exports2, module2) {
    ...
    function PricesSection(props) {
      ...
      return el(
        ...
        el("p", { className: "dm-note" }, t("pricesCurrencyHint")),
...
async function apply(ctx) {
  ...
  const reload = async () => {
    ...
    try {
      ...
      if (!localeBackfilled && config?.locale === "auto") {
        ...
        const resolved = resolveLocale2("auto");
  ...
  const injected = () => ({
    ...
    providerOf,
    t: tOf(),
    locale: resolveLocale2(store.getSnapshot().config?.locale),
    hooks: { monitor: store }
  });
