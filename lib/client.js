...
var init_styles = __esm({
  "lib/client-src/styles.js"() {
    css = [
      ...
      ".dm-dash-panel{position:fixed;left:12px;bottom:132px;z-index:80;width:460px;max-width:calc(100vw - 24px);max-height:76vh;box-sizing:border-box;border:1px solid var(--dsw-alias-border-l1);background:var(--dsw-alias-bg-overlay,var(--dsw-alias-bg-base));border-radius:12px;box-shadow:var(--dsw-shadow-lv2);display:flex;flex-direction:column;overflow:hidden;--dm-radius:12px;--dm-radius-sm:8px;--dm-radius-xs:6px;--dm-level-0:rgba(128,128,128,.16);--dm-level-1:#a7f3d0;--dm-level-2:#6ee7b7;--dm-level-3:#34d399;--dm-level-4:#10b981;--dm-unknown:rgba(128,128,128,.16);--dm-direct:#8b93a7;--dm-series-0:#0ea5e9;--dm-series-1:#f59e0b;--dm-series-2:#8b5cf6;--dm-series-3:#14b8a6;--dm-series-4:#ec4899;--dm-series-5:#84cc16}",
      ...
      ".dm-dash-strip{overflow-x:auto;padding-bottom:2px;display:flex;gap:4px}",
      ...
      ".dm-dash-table th{color:var(--dsw-alias-label-tertiary);font-size:11px;font-weight:500;line-height:16px;text-align:right;padding:0 0 5px;border-bottom:1px solid var(--dsw-alias-border-l2);white-space:nowrap;cursor:pointer;user-select:none}",
      ...
      ".dm-dash-table td:first-child{text-align:left;max-width:130px;overflow:hidden;text-overflow:ellipsis}",
...
var require_dashboard = __commonJS({
  "lib/client-src/dashboard.js"(exports2, module2) {
    ...
    function ModelTable({ data, t, money }) {
      const [sort, setSort] = useState({ by: "tokens", desc: true });
      ...
      const column = columns.find((c) => c.id === sort.by) ?? columns[2];
      ...
      const toggle = (id) => setSort((prev) => prev.by === id ? { by: id, desc: !prev.desc } : { by: id, desc: true });
      return el(
        "table",
        ...
        el("thead", null, el(
          ...
          columns.map((c) => el(
            ...
            t(c.label),
            sort.by === c.id ? el("span", { className: "dm-dash-sort-mark" }, sort.desc ? "\u2193" : "\u2191") : null
          ))
        )),
