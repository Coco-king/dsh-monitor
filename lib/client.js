  ...
  "lib/client-src/i18n.js"() {
    MESSAGES = {
      ...
      en: {
        ...
        viewSample: "View an OpenCode response example in a new window",
        itemField: "Item",
        itemKey: "Key",
...
var require_settings = __commonJS({
  "lib/client-src/settings.js"(exports2, module2) {
    ...
    var OPENCODE_SAMPLE = {
      usage: {
        rolling: { percent: 30, resetsAt: "2026-08-17T10:00:00Z" },
        weekly: { percent: 12, resetsAt: "2026-08-23T16:00:00Z" },
        monthly: null
      }
    };
    function ProviderForm(props) {
      ...
      const openSample = () => {
        try {
          const blob = new Blob([JSON.stringify(OPENCODE_SAMPLE, null, 2)], { type: "application/json" });
          const url2 = URL.createObjectURL(blob);
          const win = window.open(url2, "_blank", "noopener");
          ...
          el(
            ...
            el(
              ...
              el(
                ...
                el("button", { type: "button", className: "dm-btn ghost small", onClick: openSample }, t("viewSample"))
              )
            )
          )
        ),
