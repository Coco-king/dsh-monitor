...
var init_styles = __esm({
  "lib/client-src/styles.js"() {
    css = [
      ...
      ".dm-reset{font-size:12px;color:var(--dsw-alias-label-tertiary);padding-left:64px;white-space:nowrap;overflow:hidden;text-overflow:ellipsis}",
