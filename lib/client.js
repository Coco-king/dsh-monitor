...
var init_styles = __esm({
  "lib/client-src/styles.js"() {
    css = [
      ...
      ".dm-tier-edits{display:flex;flex-direction:column;gap:6px;padding:8px 4px 2px;font-size:12px;line-height:18px}",
      ".dm-tier-row{display:grid;grid-template-columns:minmax(0,1.4fr) repeat(3,minmax(0,1fr));gap:8px;align-items:center}",
      ...
      ".dm-tier-readonly{grid-column:2/-1;color:var(--dsw-alias-label-tertiary)}",
      // ── 响应式 ───────────────────────────────────────────────────────────────
  ...
  "lib/client-src/i18n.js"() {
    MESSAGES = {
      ...
      en: {
        ...
        exampleRolling: "Rolling 5 hours",
...
var require_settings = __commonJS({
  "lib/client-src/settings.js"(exports2, module2) {
    ...
    var { Tooltip } = require("@deepseek-ai/dsh-client-ui-primitives");
    var { formatPlain: formatPlain2, activeCurrency: activeCurrency2 } = (init_format(), __toCommonJS(format_exports));
              ...
              el(
                ...
                el(
                  ...
                  el(
                    "div",
                    { className: "dm-tier-row" },
                    el("span", { className: "dm-tier-name" }, t("legacyBase")),
                    el("span", { className: "dm-tier-readonly" }, tierLine(model.legacyBase))
                  )
                )
              )
            );
