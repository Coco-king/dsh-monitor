...
var init_styles = __esm({
  "lib/client-src/styles.js"() {
    css = [
      ...
      ".dm-field>label{font-size:12px;line-height:18px;font-weight:500;color:var(--dsw-alias-label-secondary)}",
      ...
      // ── 响应式 ───────────────────────────────────────────────────────────────
      "@media (max-width:640px){.dm-grid2{grid-template-columns:1fr}.dm-price-caption{display:none}.dm-price-fields{grid-template-columns:1fr 1fr}.dm-price-fields .dm-price-name{grid-column:1/-1}}",
  ...
  "lib/client-src/settings.js"(exports2, module2) {
    ...
    function ProviderForm(props) {
      ...
      const submit = () => {
        ...
        try {
          ...
          if (parsed !== null && typeof parsed === "object" && !Array.isArray(parsed) && Object.values(parsed).every((v) => typeof v === "string")) headers = parsed;
        } catch {
        }
            ...
            el(
              ...
              items.map((it, i) => el(
                ...
                el(
                  "div",
                  { className: "dm-grid2" },
                  field(tItem("key"), el("input", { className: "dm-input", type: "text", value: it.key, onChange: (e) => updateItem(i, "key", e.target.value) })),
                  field(tItem("label"), el("input", { className: "dm-input", type: "text", value: it.label, onChange: (e) => updateItem(i, "label", e.target.value) }))
                ),
                el(
                  "div",
                  { className: "dm-grid2" },
                  ...
                  field(tItem("path"), el("input", { className: "dm-input", type: "text", value: it.path, onChange: (e) => updateItem(i, "path", e.target.value) }))
                ),
                el(
                  "div",
                  { className: "dm-grid2" },
                  field(tItem("maxPath"), el("input", { className: "dm-input", type: "text", value: String(it.maxPath ?? ""), onChange: (e) => updateItem(i, "maxPath", e.target.value) })),
                  field(tItem("resetsAtPath"), el("input", { className: "dm-input", type: "text", value: String(it.resetsAtPath ?? ""), onChange: (e) => updateItem(i, "resetsAtPath", e.target.value) }))
                )
              ))
            ),
    ...
    function PricesSection(props) {
      ...
      const addPicked = () => {
        ...
        if (id.length === 0 || draft.models[id] !== void 0) {
          setPickedModel("");
          return;
        }
      ...
      return el(
        ...
        el(
          ...
          el(
            ...
            el(
              "select",
              { className: "dm-input", style: { maxWidth: 320 }, value: pickedModel, onChange: (e) => setPickedModel(e.target.value) },
