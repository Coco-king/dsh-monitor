...
var init_styles = __esm({
  "lib/client-src/styles.js"() {
    css = [
      ...
      // 开关槽固定 120px、内容右对齐(开关贴住「命中」输入框);删除 × 在最后一列。
      ".dm-price-caption{display:grid;grid-template-columns:minmax(0,1.6fr) 120px repeat(3,68px) 28px;gap:8px;padding:0 9px;font-size:12px;line-height:18px;font-weight:500;color:var(--dsw-alias-label-secondary)}",
      ...
      ".dm-price-fields{display:grid;grid-template-columns:minmax(0,1.6fr) 120px repeat(3,68px) 28px;gap:8px;align-items:center}",
      ...
      ".dm-tier-row{display:grid;grid-template-columns:minmax(0,1.6fr) 120px repeat(3,68px) 28px;gap:8px;align-items:center}",
