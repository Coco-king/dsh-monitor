...
4. **Prices**: Settings → Usage → Billing prices — edit prices, **add models via a picker of the models configured in Settings → Models**, or sync from the official docs.
